exports.vote = function(doc, req) {
  if(doc != null) {
    ...
    doc.rank = Object.keys(doc.votes).length;
    return [doc, 'ok'];
  }
}

exports.cancelVote = function(doc, req) {
  if(doc != null) {
...
exports.newTicket = function(doc, req) {
	var date = new Date().toISOString();
	var	attr,
		//base64 = require('base64'),
		form = JSON.parse(req.body);
	if(doc !== null){
		throw({forbidden: 'New ticket only'});
	} else {
		form.type = 'ticket';
...
exports.ticket = function(doc, req) {
	var date = new Date().toISOString();
