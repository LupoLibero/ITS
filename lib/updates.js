...
function registerTranslation (doc, form, type, element, lang) {
  ...
  if(form.hasOwnProperty(element)){
    ...
    if(typeof doc[element][lang] != 'object') {
      doc[element][lang] = {}
    }
...
exports.demand_update_field = function (doc, req) {
  ...
  if (doc !== null) {
    ...
    // if it's an translatable field
    if(typeof doc[form.element] == 'object'){
      doc[form.element][form.lang] = form.value;
    } else {
