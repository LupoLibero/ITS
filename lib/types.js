...
function activity_field () {
  ...
  var activityValidation = function (newDoc, oldDoc, newValue, oldValue, userCtx) {
    ...
    log(lastActivity[OLD_CONTENT]);
    log(oldDoc[lastActivity[CHANGE_ELEMENT]]);
    log(_.isEqual(
        lastActivity[OLD_CONTENT],
        oldDoc[lastActivity[CHANGE_ELEMENT]]
      ));
    assert(_.isEqual(
        lastActivity[OLD_CONTENT],
        oldDoc[lastActivity[CHANGE_ELEMENT]]
